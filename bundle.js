...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BoardView = __webpack_require__(160);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_BoardView2.default, { board: this.state.board, onPlay: function onPlay() {
	            return self.setState({ "board": self.props.board });
	          } })
	      );
	    }
	  }]);
	...
	var board = new _Board2.default(20);

	_reactDom2.default.render(_react2.default.createElement(App, { board: board }), document.querySelector('.container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BoardIntersection = __webpack_require__(161);
	...
	var BoardView = function (_React$Component) {
	  ...
	  function BoardView(props) {
	    ...
	    for (var i = 0; i < props.board.size; i++) {
	      for (var j = 0; j < props.board.size; j++) {
	        intersections.push(_react2.default.createElement(_BoardIntersection2.default, {
	          key: i * 100 + j,
	          board: props.board,
	  ...
	  _createClass(BoardView, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { style: this.state.style, id: 'board' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoardIntersection = function (_React$Component) {
	  _inherits(BoardIntersection, _React$Component);

	  function BoardIntersection(props) {
	    _classCallCheck(this, BoardIntersection);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BoardIntersection).call(this, props));
	  ...
	  _createClass(BoardIntersection, [{
	    ...
	    value: function handleClick() {
	      var self = this;
	      if (self.props.board.play(self.props.row, self.props.col)) self.props.onPlay();
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('div', { className: this.state.classes, style: this.state.style, onClick: this.handleClick.bind(this) });
	    }
	  }]);
